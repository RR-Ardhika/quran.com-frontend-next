...
- **New reader defaults (QUR-005, fresh installs only — no persist migration)** — Arabic font scale 5 (was 3), translation font scale 1 (was 3), wbw font scale 5 (was 3); default translation = King Fahad Quran Complex, Indonesian (id 134, was 131 Clear Quran); wbw locale Indonesian (was English); wbw display = inline below-word translation only (was hover tooltip); word click = no audio (was play audio).
